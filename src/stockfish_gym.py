...
class ChessEnv(ChessStockfishEnv):
    @override
    def __init__(
        self, stockfish_path, stockfish_elo=1350, reward_eval_elo=1500, hist=7, TC=1
    ):
        ...
        self.state = AIHandler.get_init_repr(
            [], self.reward_eval_elo, self.TC, history=self.hist
        )
