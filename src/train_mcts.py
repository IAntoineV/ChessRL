...
from models.mcts import Node, MCTS
from models.mcts_critic_model import CriticNet
import json
import os
...
def train_critic(critic, dataset, epochs=10, batch_size=32, lr=1e-3):
    ...
    for epoch in range(epochs):
        ...
        for i in range(0, len(dataset), batch_size):
            ...
            boards_tensor = torch.stack(boards) # create a tensor of shape (batchsize, 19, 8, 8)
