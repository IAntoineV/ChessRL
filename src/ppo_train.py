...
class PPOBuffer:
    def __init__(self, max_size, state_shape):
        ...
        Args:
            ...
            state_shape: Shape of the state tensor (e.g., (1, 8, 8, 104)).
        """
    ...
    def store(self, state, action, reward, done, log_prob, value):
        ...
        Args:
            state: The observed state (tensor of shape state_shape).
